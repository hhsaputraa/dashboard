...
void main() async {
  ...
  // 1. Inisialisasi service internal aplikasi
  await ApiClient().init();
  await AuthService().initSession();

  // 2. Jalankan UI aplikasi TERLEBIH DAHULU agar layar langsung tampil (responsif)
  runApp(const BankDashboardApp());

  // 3. Inisialisasi Native Push Service (APNs) secara non-blocking di background
  NativePushService.instance.init();
}
